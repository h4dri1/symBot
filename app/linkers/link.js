...
const { isDir } = require('../services/isDir')
...
module.exports = {
    ...
    linkTorrentMusic: async (torrentName, myArgs) => {
        ...
        // Create folder
        await createFolder(generateFolder(torrentName), 'Music', torrentName)
        // Create symbolic link
        await symLink(myArgs, generateFolder(torrentName), 'Music', torrentName)
    }
}